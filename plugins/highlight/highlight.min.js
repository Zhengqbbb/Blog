...
hljs.registerLanguage("yaml",function(){"use strict";return function(e){var n={className:"string",relevance:0,variants:[{begin:/'/,end:/'/},{begin:/"/,end:/"/},{begin:/\S+/}],contains:[e.BACKSLASH_ESCAPE,{className:"template-variable",variants:[{begin:",end:"},{begin:"%{",end:"}"}]}]};return{name:"YAML",case_insensitive:!0,aliases:["yml","YAML"],contains:[{className:"attr",variants:[{begin:"\\w[\\w :\\/.-]*:(?=[ \t]|$)"},{begin:'"\\w[\\w :\\/.-]*":(?=[ \t]|$)'},{begin:"'\\w[\\w :\\/.-]*':(?=[ \t]|$)"}]},{className:"meta",begin:"^---s*$",relevance:10},{className:"string",begin:"[\\|>]([0-9]?[+-])?[ ]*\\n( *)[\\S ]+\\n(\\2[\\S ]+\\n?)*"},{begin:"<%[%=-]?",end:"[%-]?%>",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0,relevance:0},{className:"type",begin:"!"+e.UNDERSCORE_IDENT_RE},{className:"type",begin:"!!"+e.UNDERSCORE_IDENT_RE},{className:"meta",begin:"&"+e.UNDERSCORE_IDENT_RE+"$"},{className:"meta",begin:"\\*"+e.UNDERSCORE_IDENT_RE+"$"},{className:"bullet",begin:"\\-(?=[ ]|$)",relevance:0},e.HASH_COMMENT_MODE,{beginKeywords:"true false yes no null",keywords:{literal:"true false yes no null"}},{className:"number",begin:"\\b[0-9]{4}(-[0-9][0-9]){0,2}([Tt \\t][0-9][0-9]?(:[0-9][0-9]){2})?(\\.[0-9]*)?([ \\t])*(Z|[-+][0-9][0-9]?(:[0-9][0-9])?)?\\b"},{className:"number",begin:e.C_NUMBER_RE+"\\b"},n]}}}());</%[%=-]?",end:"[%-]?%></[-~]?'?(\w+)(?:.|\n)*?\n\s*\1\b></",end:"></",end:"></=></|></\></\?(php|=)?></['"]?\w+['"]?$></\?php></",end:"\\></\s]+></\></script(?=\\s|></style(?=\\s|></\?xml></\\!\\[cdata\\[",end:"\\]\\]></($\"]",contains:a}}}());></='$\"]",relevance:0,contains:[e.c_line_comment_mode,e.c_block_comment_mode,l,r("keyword","all\\b"),r("variable","@{[\\w-]+}"),r("selector-tag",n+"%?",0),r("selector-id","#"+n),r("selector-class","\\."+n,0),r("selector-tag","&",0),{classname:"selector-attr",begin:"\\[",end:"\\]"},{classname:"selector-pseudo",begin:></\(,]|$></.*></[a-za-z0-9\\._:-]+></",end:"></"+e.ident_re+"(\\s*,\\s*"+e.ident_re+")*></.*?></.*?></br[></e.length;i++){var></unnamed></[^></|<<=|<=|<|===|==|=|></span></t[0].offset?e:t:"start"===t[0].event?e:t:e.length?e:t}function>